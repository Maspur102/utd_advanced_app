...
import '../../features/product/presentation/pages/detail_page.dart'; // Import Baru
import '../../features/product/domain/product_model.dart'; // Import Baru
...
import '../../features/profile/presentation/pages/profile_page.dart'; // Import Baru
...
class AppRouter {
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/profile', builder: (context, state) => const ProfilePage()), // Rute Profil
      // Rute Detail Produk yang menerima objek Product
      GoRoute(
        path: '/detail',
        builder: (context, state) {
